...
export default function ErrorMedico() {
    ...
    useEffect(() => {
        ...
        async function redireciona() {
            await pause(2)
            router.push("/signin/iris/funcionario")
        }
        redireciona()
            ...
            <div className="flex justify-center items-center mt-32 mb-32">
                <div className="max-w-lg border border-gray-400 bg-white rounded-3xl shadow flex flex-col items-center h-auto overflow-hidden">
                    ...
                    <div className="flex justify-center items-center mt-10 mb-10">
                        ...
                        Erro ao carregar os dados do Funcionário...<br/>Redirecionando para a página de login.
                        </p>
                    </div>
                </div>
            </div>
