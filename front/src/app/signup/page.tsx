...
export default function SignUp() {
    ...
    async function efetuaRegistro(data: Inputs) {
        if (!isChecked) {
            toast.error("Você precisa concordar com os Termos, Política de Privacidade e Política de Cookies para continuar.", { duration: 2000 });
        } else if (tipoUsuario === 'profissional') {
            toast.info("Cadastro de Profissional em desenvolvimento.", { duration: 2000 });
                ...
                try {
                    ...
                    if (response.status === 201) {
                        toast.success("Cadastro de Clínica realizado com sucesso.", { duration: 2000 });
                        await pause(2)
                        ...
                        toast.error(errorData.erro || 'Erro ao cadastrar clínica. Tente novamente.', { duration: 2000 });
                    }
                } catch (error) {
