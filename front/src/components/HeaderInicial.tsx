        ...
        <nav className="border-gray-200">
            <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl pt-4 pb-4">
                <div className="flex items-center space-x-6 rtl:space-x-reverse">
                    <Link href="/" className={`flex font-bold text-header-selected dark:text-header-selected hover:underline ${cairo.className}`}>
                        Início
                    </Link>
                    <Link href="/sobre-iris" className={`flex font-bold text-color-logo dark:text-color-logo hover:underline ${cairo.className}`}>
                        Sobre Íris
                    </Link>
                    <Link href="/para-clinica" className={`flex font-bold text-color-logo dark:text-color-logo hover:underline ${cairo.className}`}>
                        Para sua Clínica
                    </Link>
                    <Link href="/para-voce" className={`flex font-bold text-color-logo dark:text-color-logo hover:underline ${cairo.className}`}>
                        Para Você
                    </Link>
                    <Link href="/" className={`flex font-bold text-color-logo dark:text-color-logo hover:underline ${cairo.className}`}>
                        Contato
                    </Link>
                </div>
