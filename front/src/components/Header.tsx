        ...
        <nav className="border-gray-200">
            <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl pt-4 pb-4">
                <div className="flex items-center space-x-6 rtl:space-x-reverse">
                    ...
                    <Link href="/para-voce#pacotes-connect" className={`flex font-bold ${activeLink === "voce" ? "text-header-selected dark:text-header-selected" : "text-color-logo dark:text-color-logo"} hover:underline ${cairo.className}`}>
                        Para Você
                    </Link>
