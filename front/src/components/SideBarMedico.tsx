...
export function SideBarMedico({ activeLink }: SideBarMedicoProps) {
    ...
    return (
        <div className="h-auto w-60 pb-52 bg-[#f2f2f2] border-r border-[#252d39]">
            ...
            <div className="mt-10 flex-col justify-start items-start gap-2 inline-flex">
                ...
                <Link href="/area-medica" className={activeLink == "geral" ? "w-60 pl-11 py-2 bg-[#eaeaea] border-r-8 border-[#6d9ce3] justify-start gap-3 items-center inline-flex" : "pl-11 py-2 justify-start items-center gap-3 inline-flex"}>
                ...
                <Link href="/area-medica/agenda" className={activeLink == "agenda" ? "w-60 pl-11 py-2 bg-[#eaeaea] border-r-8 border-[#6d9ce3] justify-start gap-3 items-center inline-flex" : "pl-11 py-2 justify-start items-center gap-3 inline-flex"}>
                ...
                <Link href="/area-medica/relatorios" className={activeLink == "relatorios" ? "w-60 pl-11 py-2 bg-[#eaeaea] border-r-8 border-[#6d9ce3] justify-start gap-3 items-center inline-flex" : "pl-11 py-2 justify-start items-center gap-3 inline-flex"}>
                ...
                <Link href="/area-medica/mundo-emocoes" className={activeLink == "mundo-emocoes" ? "w-60 pl-11 py-2 bg-[#eaeaea] border-r-8 border-[#6d9ce3] justify-start gap-3 items-center inline-flex" : "pl-11 py-2 justify-start items-center gap-3 inline-flex"}>
                    ...
                    <p className={activeLink == "mundo-emocoes" ? `text-[#192333] text-[15px] font-normal ${inter.className}` : `text-[#798391] text-[15px] font-normal ${inter.className}`}>
                        Mundo das Emoções
                    </p>
                </Link>
